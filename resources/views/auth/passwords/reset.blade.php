                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 ">
																				<input name="email" class="form-control form-control-lg  @error('email') is-invalid @enderror" type="text" required autofocus placeholder="Email" value="{{ $email ?? old('email') }}">
																				@error('email')
                                ...
                                <div class="form-group row">
                                    <div class="col-12 ">
																				<input class="form-control form-control-lg" type="password @error('password') is-invalid @enderror" required placeholder="Password" name="password">
																				@error('password')
																						<span class="invalid-feedback" role="alert">
																								<strong>{{ $message }}</strong>
																						</span>
